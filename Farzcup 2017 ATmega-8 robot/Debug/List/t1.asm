...
;	MR -> Y+0
	...
	RCALL SUBOPT_0x0
	RJMP _0x36
; 0000 001F     else if(ML<=-255) ML=-255;
_0x3:
	LDD  R26,Y+2
	LDD  R27,Y+2+1
	RCALL SUBOPT_0x1
...
_0x5:
	...
	RCALL SUBOPT_0x0
	RJMP _0x37
; 0000 0021     else if(MR<=-255) MR=-255;
_0x6:
	LD   R26,Y
	LDD  R27,Y+1
	RCALL SUBOPT_0x1
...
; 0000 0054 DDRB=(1<<DDB7) | (1<<DDB6) | (1<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(225)
	OUT  0x17,R30
...
; 0000 0059 // Function: Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 005A DDRC=(0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	OUT  0x14,R30
; 0000 005B // State: Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 005C PORTC=(0<<PORTC6) | (0<<PORTC5) | (0<<PORTC4) | (0<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
	OUT  0x15,R30
; 0000 005D 
...
; 0000 0067 TCCR0=(0<<CS02) | (0<<CS01) | (0<<CS00);
	OUT  0x33,R30
...
; 0000 006D // Mode: Fast PWM top=0x00FF
; 0000 006E // OC1A output: Non-Inverted PWM
; 0000 006F // OC1B output: Non-Inverted PWM
; 0000 0070 // Noise Canceler: Off
; 0000 0071 // Input Capture on Falling Edge
; 0000 0072 // Timer Period: 2/048 ms
; 0000 0073 // Output Pulse(s):
; 0000 0074 // OC1A Period: 2/048 ms Width: 0 us// OC1B Period: 2/048 ms Width: 0 us
...
; 0000 0079 TCCR1A=(1<<COM1A1) | (0<<COM1A0) | (1<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (1<<WGM10);
	LDI  R30,LOW(161)
	OUT  0x2F,R30
; 0000 007A TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (1<<WGM12) | (0<<CS12) | (1<<CS11) | (1<<CS10);
	LDI  R30,LOW(11)
	OUT  0x2E,R30
...
; 0000 008F TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<TOIE0);
	OUT  0x39,R30
; 0000 0090 
...
; 0000 00A5 ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADFR) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	OUT  0x6,R30
; 0000 00A6 
...
; 0000 00B2       if(PIND.7==1)  motor(255,255);
	SBIS 0x10,7
	RJMP _0x2C
	RCALL SUBOPT_0x2
	LDI  R26,LOW(255)
	RJMP _0x3A
; 0000 00B3       else if(PIND.4==1)  motor(255,-255);
_0x2C:
	SBIS 0x10,4
	RJMP _0x2E
	RCALL SUBOPT_0x2
	...
	LDI  R27,HIGH(65281)
	RJMP _0x3B
; 0000 00B4       else if(PIND.5==1)  motor(0,255);
_0x2E:
	SBIS 0x10,5
	RJMP _0x30
	LDI  R30,LOW(0)
	...
	LDI  R26,LOW(255)
	RJMP _0x3A
; 0000 00B5       else if(PIND.3==1)  motor(-255,255);
_0x30:
	SBIS 0x10,3
	RJMP _0x32
	RCALL SUBOPT_0x1
	...
	LDI  R26,LOW(255)
	RJMP _0x3A
; 0000 00B6       else if(PIND.6==1)  motor(255,0);
_0x32:
	SBIS 0x10,6
	RJMP _0x34
	RCALL SUBOPT_0x2
