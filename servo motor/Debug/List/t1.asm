...
; 0000 004A // Timer Period: 2/048 ms
; 0000 004B // Output Pulse(s):
; 0000 004C // OC1A Period: 2/048 ms Width: 0 us// OC1B Period: 2/048 ms Width: 0 us
...
; 0000 0051 TCCR1A=(1<<COM1A1) | (0<<COM1A0) | (1<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (1<<WGM10);
	LDI  R30,LOW(161)
	OUT  0x2F,R30
; 0000 0052 TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (1<<WGM12) | (0<<CS12) | (1<<CS11) | (1<<CS10);
	LDI  R30,LOW(11)
	OUT  0x2E,R30
...
; 0000 0099       {PORTD.0=1;
	SBI  0x12,0
; 0000 009A       delay_ms(3);
	LDI  R26,LOW(3)
	RCALL SUBOPT_0x1
; 0000 009B       PORTD.0=0;
; 0000 009C       delay_ms(3);}
	MOVW R30,R4
	ADIW R30,1
	MOVW R4,R30
	RJMP _0x15
