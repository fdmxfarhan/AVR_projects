...
; 0000 003C // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=Out Bit2=In Bit1=In Bit0=In
; 0000 003D DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (1<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	LDI  R30,LOW(8)
	OUT  0x14,R30
; 0000 003E // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=0 Bit2=T Bit1=T Bit0=T
...
; 0000 007D // USART Receiver: On
; 0000 007E // USART Transmitter: On
; 0000 007F // USART Mode: Asynchronous
; 0000 0080 // USART Baud Rate: 9600
; 0000 0081 UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (0<<U2X) | (0<<MPCM);
	OUT  0xB,R30
; 0000 0082 UCSRB=(0<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (1<<RXEN) | (1<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(24)
	OUT  0xA,R30
...
; 0000 009F // RS - PORTC Bit 0
; 0000 00A0 // RD - PORTC Bit 1
; 0000 00A1 // EN - PORTC Bit 2
; 0000 00A2 // D4 - PORTC Bit 4
; 0000 00A3 // D5 - PORTC Bit 5
; 0000 00A4 // D6 - PORTC Bit 6
; 0000 00A5 // D7 - PORTC Bit 7
; 0000 00A6 // Characters/line: 16
; 0000 00A7 lcd_init(16);
	LDI  R26,LOW(16)
	RCALL _lcd_init
; 0000 00A8 damagetime=30;
	LDI  R30,LOW(30)
	LDI  R31,HIGH(30)
	STS  _damagetime,R30
	STS  _damagetime+1,R31
; 0000 00A9 while (ct2<1)
_0x3:
	CALL SUBOPT_0x0
	SBIW R26,1
	BRLT PC+2
...
; 0000 00BB         ct1=0;
	...
	STS  _ct1+1,R30
; 0000 00BC         }
; 0000 00BD       if(timer1>=damagetime)
_0x10:
	CALL SUBOPT_0x2
	CP   R4,R30
	CPC  R5,R31
...
; 0000 00C1         timer1=0;
	...
	CLR  R5
; 0000 00C2         }
; 0000 00C3       if(timer2>=damagetime)
_0x11:
	CALL SUBOPT_0x2
	CP   R6,R30
	CPC  R7,R31
...
; 0000 00C7         timer2=0;
	...
	CLR  R7
; 0000 00C8         }
; 0000 00C9       if(timer3>=damagetime)
_0x14:
	CALL SUBOPT_0x2
	CP   R8,R30
	CPC  R9,R31
...
; 0000 00CD         timer3=0;
	...
	CLR  R9
; 0000 00CE         }
; 0000 00CF       if(timer4>=damagetime)
_0x17:
	CALL SUBOPT_0x2
	CP   R10,R30
	CPC  R11,R31
...
_0x1A:
	...
	CALL _delay_ms
; 0000 00D8 
; 0000 00D9       lcd_gotoxy(5,0);
	LDI  R30,LOW(5)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 00DA       lcd_putchar((ct2/10)%10+'0');
	CALL SUBOPT_0x0
	CALL SUBOPT_0x3
; 0000 00DB       lcd_putchar((ct2/1)%10+'0');
	CALL SUBOPT_0x0
	CALL SUBOPT_0x4
; 0000 00DC       lcd_putchar(':');
	LDI  R26,LOW(58)
	RCALL _lcd_putchar
; 0000 00DD       lcd_putchar((ct1/10)%10+'0');
	CALL SUBOPT_0x1
	CALL SUBOPT_0x3
; 0000 00DE       lcd_putchar((ct1/1)%10+'0');
	CALL SUBOPT_0x1
	CALL SUBOPT_0x4
; 0000 00DF 
; 0000 00E0       lcd_gotoxy(0,1);
	LDI  R30,LOW(0)
	CALL SUBOPT_0x5
; 0000 00E1       lcd_putchar((timer1/10)%10+'0');
	MOVW R26,R4
	CALL SUBOPT_0x3
; 0000 00E2       lcd_putchar((timer1/1)%10+'0');
	MOVW R26,R4
	CALL SUBOPT_0x4
; 0000 00E3 
; 0000 00E4       lcd_gotoxy(4,1);
	LDI  R30,LOW(4)
	CALL SUBOPT_0x5
; 0000 00E5       lcd_putchar((timer2/10)%10+'0');
	MOVW R26,R6
	CALL SUBOPT_0x3
; 0000 00E6       lcd_putchar((timer2/1)%10+'0');
	MOVW R26,R6
	CALL SUBOPT_0x4
; 0000 00E7 
; 0000 00E8       lcd_gotoxy(8,1);
	LDI  R30,LOW(8)
	CALL SUBOPT_0x5
; 0000 00E9       lcd_putchar((timer3/10)%10+'0');
	MOVW R26,R8
	CALL SUBOPT_0x3
; 0000 00EA       lcd_putchar((timer3/1)%10+'0');
	MOVW R26,R8
	CALL SUBOPT_0x4
; 0000 00EB 
; 0000 00EC       lcd_gotoxy(12,1);
	LDI  R30,LOW(12)
	CALL SUBOPT_0x5
; 0000 00ED       lcd_putchar((timer4/10)%10+'0');
	MOVW R26,R10
	CALL SUBOPT_0x3
; 0000 00EE       lcd_putchar((timer4/1)%10+'0');
	MOVW R26,R10
	CALL SUBOPT_0x4
; 0000 00EF 
; 0000 00F0 
