...
; 0000 007B // USART Baud Rate: 38400
; 0000 007C UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (0<<U2X) | (0<<MPCM);
	OUT  0xB,R30
; 0000 007D UCSRB=(0<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (1<<RXEN) | (1<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(24)
	OUT  0xA,R30
...
; 0000 00A3 
; 0000 00A4 
; 0000 00A5 /*puts("AT+ROLE=1\r\n");
; 0000 00A6 puts("AT+CMODE=0\r\n");
; 0000 00A7 puts("AT+BIND=2016,4,51108\r\n");
; 0000 00A8 //2016:4:51108
; 0000 00A9   */
; 0000 00AA while (1)
_0x3:
; 0000 00AB       {
