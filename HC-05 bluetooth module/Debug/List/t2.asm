...
; 0000 0081 // USART Baud Rate: 38400
; 0000 0082 UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (0<<U2X) | (0<<MPCM);
	OUT  0xB,R30
; 0000 0083 UCSRB=(0<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (1<<RXEN) | (1<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(24)
	OUT  0xA,R30
...
; 0000 009B TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 009C 
; 0000 009D // Graphic Display Controller initialization
; 0000 009E // The PCD8544 connections are specified in the
; 0000 009F // Project|Configure|C Compiler|Libraries|Graphic Display menu:
; 0000 00A0 // SDIN - PORTC Bit 0
; 0000 00A1 // SCLK - PORTC Bit 1
; 0000 00A2 // D /C - PORTC Bit 2
; 0000 00A3 // /SCE - PORTC Bit 3
; 0000 00A4 // /RES - PORTC Bit 4
; 0000 00A5 
...
; 0000 00AD glcd_init_data.writexmem=NULL;
	STD  Y+4,R30
	STD  Y+4+1,R30
; 0000 00AE // Set the LCD temperature coefficient
; 0000 00AF glcd_init_data.temp_coef=PCD8544_DEFAULT_TEMP_COEF;
	LDD  R30,Y+6
	ANDI R30,LOW(0xFC)
	STD  Y+6,R30
; 0000 00B0 // Set the LCD bias
; 0000 00B1 glcd_init_data.bias=PCD8544_DEFAULT_BIAS;
	ANDI R30,LOW(0xE3)
	ORI  R30,LOW(0xC)
	STD  Y+6,R30
; 0000 00B2 // Set the LCD contrast control voltage VLCD
; 0000 00B3 glcd_init_data.vlcd=PCD8544_DEFAULT_VLCD;
	LDD  R30,Y+7
	ANDI R30,LOW(0x80)
	ORI  R30,LOW(0x32)
	STD  Y+7,R30
; 0000 00B4 
; 0000 00B5 glcd_init(&glcd_init_data);
	MOVW R26,R28
	RCALL _glcd_init
; 0000 00B6 
; 0000 00B7 while (1)
...
; 0000 00BA       glcd_putchar(getchar());
	CALL _getchar
	MOV  R26,R30
	CALL _glcd_putchar
; 0000 00BB       }
