...
; 0000 0099       a=0;
	CLR  R4
	CLR  R5
; 0000 009A       while(PINA.0==0);
_0x6:
	SBIS 0x19,0
	RJMP _0x6
; 0000 009B       while(PINA.0==1)
_0x9:
	SBIS 0x19,0
	RJMP _0xB
; 0000 009C         {
...
; 0000 00A0       lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 00A1       lcd_putchar((a/1000)%10+'0');
	MOVW R26,R4
	LDI  R30,LOW(1000)
	LDI  R31,HIGH(1000)
	RCALL SUBOPT_0x0
; 0000 00A2       lcd_putchar((a/100)%10+'0');
	LDI  R30,LOW(100)
	LDI  R31,HIGH(100)
	RCALL SUBOPT_0x0
; 0000 00A3       lcd_putchar((a/10)%10+'0');
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	RCALL SUBOPT_0x0
; 0000 00A4       lcd_putchar((a/1)%10+'0');
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	CALL __MODW21
	SUBI R30,-LOW(48)
