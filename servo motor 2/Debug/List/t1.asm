...
_servo:
; .FSTART _servo
; 0000 0023     OCR1B=(degree*254)/110;
	ST   -Y,R27
	ST   -Y,R26
;	degree -> Y+0
	LD   R30,Y
...
; 0000 0051 // OC1A output: Non-Inverted PWM
; 0000 0052 // OC1B output: Non-Inverted PWM
; 0000 0053 // Noise Canceler: Off
; 0000 0054 // Input Capture on Falling Edge
; 0000 0055 // Timer Period: 2/048 ms
; 0000 0056 // Output Pulse(s):
; 0000 0057 // OC1A Period: 2/048 ms Width: 0 us// OC1B Period: 2/048 ms Width: 0 us
...
; 0000 005C TCCR1A=(1<<COM1A1) | (0<<COM1A0) | (1<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (1<<WGM10);
	LDI  R30,LOW(161)
	OUT  0x2F,R30
; 0000 005D TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (1<<WGM12) | (0<<CS12) | (1<<CS11) | (1<<CS10);
	LDI  R30,LOW(11)
	OUT  0x2E,R30
