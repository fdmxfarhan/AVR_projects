...
// I2C Bus Slave Address: 0x50
twi_slave_init(false,0x50,twi_rx_buffer,sizeof(twi_rx_buffer),twi_tx_buffer,twi_rx_handler,twi_tx_handler);
twi_master_init(8);
...
while (1)
      ...
      twi_master_trans(0x51,(unsigned char *) twi_tx_buffer,8,(unsigned char *) twi_rx_buffer,8);  
