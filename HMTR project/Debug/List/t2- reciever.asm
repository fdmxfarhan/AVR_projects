...
; 0000 002D // Function: Bit6=In Bit5=Out Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 002E DDRC=(0<<DDC6) | (1<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	LDI  R30,LOW(32)
	OUT  0x14,R30
; 0000 002F // State: Bit6=T Bit5=0 Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 008C       a=getchar();
	RCALL _getchar
	MOV  R5,R30
; 0000 008D       if(a=='S') PORTC.5=1;
	LDI  R30,LOW(83)
	CP   R30,R5
	BRNE _0x6
	SBI  0x15,5
; 0000 008E       else       PORTC.5=0;
	RJMP _0x9
_0x6:
	CBI  0x15,5
; 0000 008F       }
