...
_0x0:
	.DB  0x41,0x54,0x2B,0x52,0x4F,0x4C,0x45,0x3F
	.DB  0xD,0xA,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 00F1 // USART Baud Rate: 38400 (Double Speed Mode)
; 0000 00F2 UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (1<<U2X) | (0<<MPCM);
	LDI  R30,LOW(2)
	OUT  0xB,R30
...
; 0000 0110 // RS - PORTC Bit 0
; 0000 0111 // RD - PORTC Bit 1
; 0000 0112 // EN - PORTC Bit 2
; 0000 0113 // D4 - PORTC Bit 4
; 0000 0114 // D5 - PORTC Bit 5
; 0000 0115 // D6 - PORTC Bit 6
; 0000 0116 // D7 - PORTC Bit 7
...
; 0000 011B #asm("sei")
	sei
; 0000 011C 
; 0000 011D delay_ms(5000);
	LDI  R26,LOW(5000)
	LDI  R27,HIGH(5000)
	CALL _delay_ms
; 0000 011E puts("AT+ROLE?\r\n");
	__POINTW2MN _0x14,0
	CALL _puts
; 0000 011F 
; 0000 0120 
