...
_0x0:
	...
	.DB  0x50,0x41,0x49,0x52,0x0,0x20,0x3C,0x3D
	.DB  0x20,0x20,0x20,0x20,0x7C,0x7C,0x20,0x20
	.DB  0x20,0x20,0x3D,0x3E,0x0,0x63,0x6F,0x6E
	.DB  0x74,0x69,0x6E,0x75,0x65,0x0,0x4D,0x73
	.DB  0x74,0x20,0x20,0x20,0x20,0x74,0x73,0x74
	.DB  0x20,0x20,0x20,0x53,0x6C,0x76,0x0,0x3E
	.DB  0x41,0x54,0x0,0x41,0x54,0xD,0xA,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 006E // USART Baud Rate: 38400
; 0000 006F UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (0<<U2X) | (0<<MPCM);
	OUT  0xB,R30
; 0000 0070 UCSRB=(0<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (1<<RXEN) | (1<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(24)
	OUT  0xA,R30
...
; 0000 0095 lcd_init(16);
	...
	RCALL _lcd_init
; 0000 0096 
; 0000 0097 lcd_gotoxy(5,0);
	LDI  R30,LOW(5)
	RCALL SUBOPT_0x0
; 0000 0098 lcd_putsf("Welcome");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
...
; 0000 009D lcd_putsf("PAIR");
	__POINTW2FN _0x0,8
	RCALL SUBOPT_0x2
; 0000 009E lcd_gotoxy(0,1);
; 0000 009F lcd_putsf(" <=    ||    =>");
; 0000 00A0 while(PINC.2==0);
_0x3:
	SBIS 0x13,2
	RJMP _0x3
...
; 0000 00A5 lcd_gotoxy(0,0);
	LDI  R30,LOW(0)
	RCALL SUBOPT_0x0
; 0000 00A6 lcd_putsf("continue");
	__POINTW2FN _0x0,29
	RCALL SUBOPT_0x2
; 0000 00A7 lcd_gotoxy(0,1);
; 0000 00A8 lcd_putsf(" <=    ||    =>");
; 0000 00A9 while(PINC.2==0);
_0x8:
	SBIS 0x13,2
	RJMP _0x8
...
; 0000 00AE lcd_putsf("Mst    tst   Slv");
	__POINTW2FN _0x0,38
	RCALL SUBOPT_0x2
; 0000 00AF lcd_gotoxy(0,1);
; 0000 00B0 lcd_putsf(" <=    ||    =>");
; 0000 00B1 while(PINC.0==0 && PINC.1==0 && PINC.2==0);
_0xB:
	SBIC 0x13,0
	RJMP _0xE
	SBIC 0x13,1
...
; 0000 00B8     puts("AT\r\n");
	__POINTW2MN _0x11,0
	RCALL _puts
; 0000 00B9 //    lcd_putchar(getchar());
; 0000 00BA //    lcd_putchar(getchar());
; 0000 00BB //    lcd_putchar(getchar());
; 0000 00BC     }
; 0000 00BD delay_ms(500);
_0x10:
	RCALL SUBOPT_0x3
	RCALL _delay_ms
; 0000 00BE while(PINC.0==0 && PINC.1==0 && PINC.2==0);
_0x12:
	SBIC 0x13,0
	RJMP _0x15
	SBIC 0x13,1
