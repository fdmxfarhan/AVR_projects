...
; 0000 0079 // USART Baud Rate: 38400
...
; 0000 009F // Characters/line: 8
; 0000 00A0 lcd_init(8);
	LDI  R26,LOW(8)
	RCALL _lcd_init
; 0000 00A1 
; 0000 00A2 delay_ms(4000);
	LDI  R26,LOW(4000)
	LDI  R27,HIGH(4000)
	CALL _delay_ms
; 0000 00A3 puts("AT\r\n");
