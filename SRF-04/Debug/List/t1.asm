...
; 0000 0026 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=Out
; 0000 0027 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(1)
	OUT  0x1A,R30
; 0000 0028 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=0
...
_0x3:
; 0000 0098     {
; 0000 0099     PORTA.0 = 1;	//trigger -> 1
	SBI  0x1B,0
; 0000 009A     delay_us(10);
	__DELAY_USB 27
; 0000 009B     PORTA.0 = 0;	//trigger -> 0
	CBI  0x1B,0
; 0000 009C     cnt = 0;
	CLR  R6
	CLR  R7
; 0000 009D 
; 0000 009E     while(PINA.1 == 0);
_0xA:
	SBIS 0x19,1
	RJMP _0xA
; 0000 009F     while(PINA.1 == 1)   cnt++;
_0xD:
	SBIS 0x19,1
	RJMP _0xF
	MOVW R30,R6
...
; 0000 00A1     lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 00A2     lcd_putchar((s/1000)%10+'0');
	MOVW R26,R4
	LDI  R30,LOW(1000)
	LDI  R31,HIGH(1000)
	RCALL SUBOPT_0x0
; 0000 00A3     lcd_putchar((s/100)%10+'0');
	LDI  R30,LOW(100)
	LDI  R31,HIGH(100)
	RCALL SUBOPT_0x0
; 0000 00A4     lcd_putchar((s/10)%10+'0');
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	RCALL SUBOPT_0x0
; 0000 00A5     lcd_putchar((s/1)%10+'0');
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	CALL __MODW21
	SUBI R30,-LOW(48)
